(function() {
  ...
  Listing = (function() {
    ...
    Listing.prototype.updateInventory = function(listing, cb) {
      return this.client.put("/listings/" + this.listingId + "/inventory", listing, function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
    ...
    Listing.prototype.uploadListingImage = function(shop, imageData, cb) {
      return this.client.post("/shops/" + shop + "/listings/" + this.listingId + "/images", imageData, "multipart/form-data", function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 201) {
