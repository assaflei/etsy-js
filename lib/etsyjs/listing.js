(function() {
  ...
  Listing = (function() {
    ...
    Listing.prototype.uploadListingVideo = function() {
      ...
      return (_ref = this.client).postMultipart.apply(_ref, ["/shops/" + shop + "/listings/" + this.listingId + "/videos", videoData].concat(__slice.call(params), [function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 201) {
