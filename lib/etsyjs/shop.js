(function() {
  ...
  Shop = (function() {
    ...
    Shop.prototype.draftListings = function(_arg, cb) {
      var limit, offset, params, secret, token, _ref;
      token = _arg.token, secret = _arg.secret, limit = _arg.limit, offset = _arg.offset;
      params = {};
      if (limit != null) {
      ...
      return (_ref = this.client).get.apply(_ref, ["/shops/" + this.shopId + "/listings/draft", token, secret].concat(__slice.call(params), [function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
    ...
    Shop.prototype.expiredListings = function(_arg, cb) {
      var limit, offset, params, secret, token, _ref;
      token = _arg.token, secret = _arg.secret, limit = _arg.limit, offset = _arg.offset;
      params = {};
      if (limit != null) {
      ...
      return (_ref = this.client).get.apply(_ref, ["/shops/" + this.shopId + "/listings/expired", token, secret].concat(__slice.call(params), [function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
    ...
    Shop.prototype.inactiveListings = function(_arg, cb) {
      var limit, offset, params, secret, token, _ref;
      token = _arg.token, secret = _arg.secret, limit = _arg.limit, offset = _arg.offset;
      params = {};
      if (limit != null) {
      ...
      return (_ref = this.client).get.apply(_ref, ["/shops/" + this.shopId + "/listings/inactive", token, secret].concat(__slice.call(params), [function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
