(function() {
  ...
  Search = (function() {
    ...
    Search.prototype.findAllShops = function(params, cb) {
      return this.client.get("/shops", params, function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
          return cb(new Error('Search shops error'));
        } else {
          return cb(null, body, headers);
        }
      });
