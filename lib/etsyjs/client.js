(function() {
  var Address, Category, Client, FormData, HttpError, Listing, Me, OAuth, Receipt, Search, Shop, User, querystring, request, util,
  ...
  Client = (function() {
    function Client(options) {
      ...
      this.oauth2Scopes = 'email_r profile_r address_r address_w shops_w';
      ...
      this.etsyOAuth2 = new OAuth.OAuth2("" + this.apiKey, "" + this.apiSecret, 'https://openapi.etsy.com', "" + this.oauth2AuthPath, '/v3/public/oauth/token', {
    ...
    Client.prototype.get = function() {
      ...
      if ((this.authenticatedToken != null) && (this.authenticatedSecret != null) && (this.oauth2Token != null)) {
    ...
    Client.prototype.put = function(path, content, contentType, callback) {
      var url;
      ...
      return this.etsyOAuth2._request("PUT", url, {
        'Authorization': this.etsyOAuth2.buildAuthHeader(this.oauth2Token),
        'Content-Type': contentType
      }, content, this.oauth2Token, (function(_this) {
    ...
    Client.prototype.patch = function(path, content, contentType, callback) {
      var url;
      url = this.buildUrl(path);
      if (contentType == null) {
        contentType = "application/x-www-form-urlencoded";
      ...
      return this.etsyOAuth2._request("PATCH", url, {
        'Authorization': this.etsyOAuth2.buildAuthHeader(this.oauth2Token),
        'Content-Type': contentType
      }, content, this.oauth2Token, (function(_this) {
        return function(err, data, res) {
    ...
    Client.prototype.post = function(path, content, contentType, callback) {
      var url;
      url = this.buildUrl(path);
      if (contentType == null) {
        contentType = "application/x-www-form-urlencoded";
      ...
      return this.etsyOAuth2._request("POST", url, {
        'Authorization': this.etsyOAuth2.buildAuthHeader(this.oauth2Token),
        'Content-Type': contentType
      }, content, this.oauth2Token, (function(_this) {
        return function(err, data, res) {
    ...
    Client.prototype.postMultipart = function() {
      var callback, content, form, key, params, path, url, valKey, valValue, value, _i;
      path = arguments[0], content = arguments[1], params = 4 <= arguments.length ? __slice.call(arguments, 2, _i = arguments.length - 1) : (_i = 2, []), callback = arguments[_i++];
      url = new URL(this.buildUrl(path));
    ...
    Client.prototype.postVideoMultipart = function() {
      var callback, content, form, key, params, path, url, valKey, valValue, value, _i;
      path = arguments[0], content = arguments[1], params = 4 <= arguments.length ? __slice.call(arguments, 2, _i = arguments.length - 1) : (_i = 2, []), callback = arguments[_i++];
      url = new URL(this.buildUrl(path));
      console.log("==> Perform multipart POST request on " + url + " with " + (typeof content) + " content");
    ...
    Client.prototype["delete"] = function(path, content, contentType, callback) {
      var url;
      url = this.buildUrl(path);
      if (contentType == null) {
        contentType = "application/x-www-form-urlencoded";
      ...
      return this.etsyOAuth2._request("DELETE", url, {
        'Authorization': this.etsyOAuth2.buildAuthHeader(this.oauth2Token),
        'Content-Type': contentType
      }, content, this.oauth2Token, (function(_this) {
        return function(err, data, res) {
    ...
    Client.prototype.getAuthenticated = function() {
      ...
      if (this.oauth2Token == null) {
        ...
        return this.etsyOAuth2.get(url, this.oauth2Token, (function(_this) {
          return function(err, data, res) {
            if (err) {
              return callback(err);
            }
    ...
    Client.prototype.accessTokenOA1To2 = function(clientId, legacyToken, callback) {
      var content, grantType, params, url;
      ...
      url = this.etsyOAuth2._baseSite + this.etsyOAuth2._accessTokenUrl;
      content = querystring.stringify(params);
      console.log("==> Perform PUT request on " + url + " with " + (JSON.stringify(content)));
      return this.etsyOAuth2._request("POST", url, {
        'Content-Type': 'application/x-www-form-urlencoded'
      }, content, null, (function(_this) {
        return function(err, token_data) {
